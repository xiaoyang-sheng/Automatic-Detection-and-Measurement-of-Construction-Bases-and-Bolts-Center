...
# img3 = cv2.GaussianBlur(th2, (3, 3), 0)
# img4 = cv2.GaussianBlur(img, (3, 3), 0)
# img5 = cv2.GaussianBlur(th3, (3, 3), 0)
# canny = cv2.Canny(img3, 50, 150)
# canny2 = cv2.Canny(img4, 50, 150)
# canny3 = cv2.Canny(img5, 50, 150)
...
circles2 = cv2.HoughCircles(gray_blurred, cv2.HOUGH_GRADIENT, 1, 20, 50, 30, 0, 0)
print(circles2)
...
#         #  获取圆的坐标与半径
#         i = circle
#         cv2.circle(img_2, (int(i[0]), int(i[1])), int(i[2]), (0, 0, 255), 4)
#         cv2.imwrite('circle_th3_res.jpg', img_2)
