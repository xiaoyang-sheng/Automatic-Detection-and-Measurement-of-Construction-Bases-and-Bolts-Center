...
def get_camera_matrix(images, criteria):
    ...
    for fname in images:
        ...
        if ret:
            ...
            # cv2.imshow('img', img)
            file_name = "./tt_4/Points_" + num_to_alphabet(cnt) + ".jpg"
...
def main():
    ...
    for fname in images:
        ...
        file_name = "./paper/AF_" + num_to_alphabet(cnt) + ".jpg"
